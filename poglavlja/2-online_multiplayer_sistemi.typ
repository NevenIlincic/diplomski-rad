...
Клијент-сервер архитектура представља централизовани модел у којем су сви учесници (клијенти) повезани на један централни чвор - сервер. За разлику од P2P модела, клијенти не комуницирају директно међусобно, већ се свака размена података одвија искључиво преко сервера (приказан на слици @fig:client-server).
